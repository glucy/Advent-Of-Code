# Not my solution.  To complicated for me :-(
...
def main():
    ...
    print "Answer to part 1: ", play_hero(hero_hp, boss_hp, boss_damage, hero_armor,
                                          hero_mana, mana_spent, timers, False)
    print "Answer to part 2: ", play_hero(hero_hp, boss_hp, boss_damage, hero_armor,
                                          hero_mana, mana_spent, timers, True)
